...
/*
 * Fragment Shader using uniform to get data from cpu code,
 * we will set the uniform variable in the render loop in the
 * main function (see line 167)
 */
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        /*Important values that will be sent into
