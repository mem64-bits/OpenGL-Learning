...
/*Fragment and vertex shaders are defined as strings to simplify code.
 *
 * As we write more advanced shaders, with multiple attributes,
 * the need to share data becomes necessary, in order link various
 * related properties and share information. 
 *
 * We can use shader inputs and outputs as a way of sharing
 * shader attributes between the fragment and vertex shader.
 */
const char* vertexShaderSource = /*Vertex Shader*/R"(

#version 330 core

// Links Vertex Shader to VBO, to get vertex data from cpu
layout (location = 0) in vec3 aPos;

// This declares an output variable that can be shared between shaders as an input attribute
...
const char* fragmentShaderSource = /*Fragment Shader*/R"(
